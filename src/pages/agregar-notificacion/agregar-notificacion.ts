...
import {ViewController, NavParams, LoadingController,AlertController, Platform } from 'ionic-angular';
...
export class AgregarNotificacionPage {
    ...
    usuarios:any= [];
    notification:any= {};
    constructor(public viewctrl:ViewController, api:Api,public loading:LoadingController, public alert:AlertController, public platform:Platform) {
        this.api = api;
        this.getUsuarios();
        this.notification = {
                titulo:"",
    ...
    rellenado(){
        return  !(this.notification.titulo.length >3 && this.notification.contenido.length >3 && this.notification.users_id.length >= 1 && this.notification.programado != "");
    }
